        ...
        <div className="card mb-4 border-0 shadow">
            <div className="row g-0 p-3 align-items-center">
                <div className="col-md-5 mb-lg-0 mb-md-0 mb-3">
                    <img src={require("../../../Images/almuerzo.jpg")} className="img-fluid rounded" alt="Room" />
                </div>
                <div className="col-md-5 px-lg-3 px-md-3 px-0">
                    <h5 className="mb-3" style={{ fontWeight: '600', color: '#A96596' }}>Tipo de servicio: Almuezo</h5>
                    <div className="features mb-4">
                        ...
                        <span className="badge rounded-pill bg-light text-dark text-wrap">
                            Almuerzo con menú del día que incluye plato principal, entrada y postre
                        </span>
                    </div>
