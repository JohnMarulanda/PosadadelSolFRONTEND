...
const HabSencilla = ({ handleClick }) => {
  ...
  const handleReservarClick = async() => {
    ...
    try {
      const response = await axios.get('http://localhost:4000/lastReserva');
      const reserva_id = response.data[0].max;
          ...
          <h5 className="mb-3" style={{ fontWeight: "600", color: "#A96596" }}>
            Tipo de habitación: Sencilla
                ...
                <div className="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
                    <h6 className="mb-4" style={{ fontWeight: '600', color: '#A96596' }}>Desde $100.000</h6>
                    {tokenExists && (
